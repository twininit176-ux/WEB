(function() {
    ...
    w("Promise", function(a) {
        ...
        b.race = function(e) {
            return new b(function(h, l) {
                for (var n = ia(e), r = n.next(); !r.done; r = n.next()) d(r.value).D(h, l)
            })
        };
        b.all = function(e) {
            var h = ia(e),
            ...
            return l.done ? d([]) : new b(function(n, r) {
                ...
                var v = [],
                    y = 0;
                do v.push(void 0), y++, d(l.value).D(S(v.length - 1), r), l = h.next(); while (!l.done)
            })
        };
        return b
    }, "es6");
    ...
    */
    ...
    function Ma(a, b) {
        ...
        return J(function(d) {
            ...
            if (d.g != 2) return c = d.h, d.return({
                response: c[0],
                error: c[1]
            });
            G(d);
    ...
    */
    ...
    function Wa(a) {
        var b;
        return J(function(c) {
            if (c.g == 1) return c.m = 2, F(c, window.android.webview.getExperimentalMediaIntegrityTokenProvider({
    ...
    function cb(a) {
        return J(function(b) {
            if (b.g == 1) {
                if (bb(a)) var c = db(a);
                else a.g = new P(a.config.C, a.config.B, a.o, a.config.j), c = Ca(a.g);
                return F(b, c, 2)
            }
            a.l = b.h;
    ...
    function db(a) {
        var b, c, d;
        return J(function(f) {
            if (f.g == 1) return b = M((a.j ? "https://ep2.adtrafficquality.google/sodar/" : "https://tpc.googlesyndication.com/sodar/") + "sodar2/237/runner.html"), F(f, xa(b), 2);
            if (f.g != 4) {
                c = f.h;
                ...
                return a.i.g ? (g = a.config, e = g.j ? "https://ep2.adtrafficquality.google" : "https://tpc.googlesyndication.com", e = e.indexOf("https:") === -1 ? "http:" + e : e, a.i.h.postMessage(JSON.stringify([g.context,
                    g.C, g.B, g.I, g.F, g.K, g.H === void 0 ? "n" : g.H, g.o === void 0 ? "0" : g.o, g.G === void 0 ? "1" : g.G, g.j === void 0 ? "0" : g.j ? "1" : "0"
                ]), e), f.return(void 0)) : F(f, Ma(a.i, {
                    X: a.config.C,
                    J: a.config.B,
                    o: a.o,
                    j: a.config.j
